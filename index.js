...
var generateMediaChannelDynamicKey = function(req, resp){
    ...
    var media_channel_key = DynamicKey5.generateMediaChannelKey(APP_ID, APP_CERTIFICATE, channelName, unixTs, randomInt, 1322058803, expiredTs);
...
http.createServer(app).listen(app.get('port'), function() {
 	console.log('Agora Recording Server Tester starts at ', app.get('port'));
});
